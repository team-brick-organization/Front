...
function MypageCardList({ data }: MypageCardListProps) {
  return (
    <div className="min-w-768pxr max-w-880pxr justify-center divide-y divide-gray-04 mb:grid mb:w-full mb:min-w-0pxr mb:grid-cols-[repeat(auto-fit,minmax(212px,212px))] mb:gap-x-10pxr mb:gap-y-32pxr mb:divide-y-0 mb:pt-24pxr">
      {data.map((item) => (
        <div
